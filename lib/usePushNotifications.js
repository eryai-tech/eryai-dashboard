...
export function usePushNotifications(userId, customerId) {
  ...
  // Debug: Log when hook receives props
  useEffect(() => {
    console.log('🔔 usePushNotifications initialized with:', { userId, customerId });
  }, [userId, customerId]);
  ...
  const subscribe = useCallback(async () => {
    ...
    try {
      ...
      console.log('📱 Push subscribe - customerId:', customerId);
      console.log('📱 Push subscribe - endpoint:', subJson.endpoint);
